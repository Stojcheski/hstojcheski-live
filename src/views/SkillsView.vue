      ...
      <div class="skills-grid">
        <div class="skill-category">
          ...
          <ul class="skill-list">
            ...
            <li class="skill-item">
              <span class="skill-name">Salesforce CPQ</span>
              <div class="skill-bar">
        ...
        <div class="skill-category">
          <h2><i class="icon tools"></i>Tools & Methodologies</h2>
          <ul class="skill-list">
            <li class="skill-item">
            ...
            <li class="skill-item">
              <span class="skill-name">Agile Development</span>
              <div class="skill-bar">
                <div class="skill-level" style="width: 85%"></div>
              </div>
            </li>
            <li class="skill-item">
              <span class="skill-name">Salesforce CLI</span>
              <div class="skill-bar">
                <div class="skill-level" style="width: 90%"></div>
              </div>
            </li>
